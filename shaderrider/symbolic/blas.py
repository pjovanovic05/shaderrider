...
class GemmOP(ast.Operator):
    ...
    def __init__(self, A, B, C, alpha=ast.Constant(1.0), beta=ast.Constant(0.0),
                 transA=ast.Constant(False), transB=ast.Constant(False), parents=None):
...
class GemvOP(ast.Operator):
    ...
    def __init__(self, A, X, Y, alpha=ast.Constant(1.0), beta=ast.Constant(0.0), transA=ast.Constant(False), parents=None):
